          ...
          <div class="col-md-6">
            ...
            <p class="text-left text-n-alinear" style=" font-family: 'Montserrat', sans-serif;">
              ...
              <i class="fa fa-check-square-o" aria-hidden="true"></i> Sistemas de gestión <br>
               <i class="fa fa-check-square-o" aria-hidden="true"></i> Tecnología de información <br>
               <i class="fa fa-check-square-o" aria-hidden="true"></i> Expansión de negocios <br>
               <i class="fa fa-check-square-o" aria-hidden="true"></i> Asesoría administrativa<br>
               <i class="fa fa-check-square-o" aria-hidden="true"></i> Asesoría legal<br>
               <i class="fa fa-check-square-o" aria-hidden="true"></i> Asesoría financiera
            </p>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            ...
            <div class="col-md-2 scrollflow -slide-left">
              ...
              <p>
               ...
               <i class="fa fa-check-square-o" aria-hidden="true"></i> Transparencia<br>
               <!-- <i class="fa fa-check-square-o" aria-hidden="true"></i> Discresión <br> -->
               <i class="fa fa-check-square-o" aria-hidden="true"></i> Legalidad y respeto
               <!-- <i class="fa fa-check-square-o" aria-hidden="true"></i> Respeto -->
              </p>
            </div>
          </div>
        </div>
